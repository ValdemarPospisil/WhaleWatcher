...
object DummyData {
    ...
    val mediaServers = DummyCategory(
        title = "Media Server",
        images = listOf(
    ...
    val customLists = listOf(
        DummyCategory("My Weekend Project", listOf(DummyDockerImage("louislam", "uptime-kuma", "Monitoring tool", 5400, "50M+"))),
        DummyCategory("Homelab Services", listOf(DummyDockerImage("portainer", "portainer-ce", "Management UI", 8000, "1B+"))),
