...
class DockerHubApiTest {
    ...
    @Test
    fun getPublicRepositories_returnsParsedResponse() =
        runBlocking {
    ...
    @Test
    fun searchRepositories_returnsParsedResponse() =
        runBlocking {
            val mockResponseJson =
                """
                {
    ...
    @Test
    fun getRepository_returnsParsedResponse() =
        runBlocking {
            val mockResponseJson =
                """
                {
    ...
    @Test
    fun getRepositoryTags_returnsParsedResponse() =
        runBlocking {
            val mockResponseJson =
                """
                {
